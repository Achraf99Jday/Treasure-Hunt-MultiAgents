...
import eu.su.mas.dedaleEtu.mas.agents.dummies.explo.CollectAgent;
...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		*/
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, DummyWumpusShift.class.getName(), entityParameters3);
		agentList.add(ag);	
		*/
//		/*********
//		 * AGENT Explo1
...
//		 *********/
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo4={"A2","A3"};
...
//		 * AGENT Explo5
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo5={"A1","A3"};
...
//		 * AGENT Explo6
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo6={"A1","A2"};
...
//		 * AGENT Explo7
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo7={"1stAgent","2ndAgent","3ndAgent"};
...
//		
//		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, CollectAgent.class.getName(), entityParametersC1);
		agentList.add(ag);
