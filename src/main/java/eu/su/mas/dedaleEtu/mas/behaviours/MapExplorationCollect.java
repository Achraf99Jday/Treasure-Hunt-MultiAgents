		...
		if (myPosition!=null){
			...
			if (this.openNodes.isEmpty()){
				...
				if (nextNode==null){
					...
					{
					int current_size = (this.myMap.getShortestPathCollect(myPosition, this.openNodes.get(i))).size();
				    ...
				    nextNode=this.myMap.getShortestPathCollect(myPosition, this.openNodes.get(best_i)).get(0);
